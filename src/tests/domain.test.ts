...
const workspace = {
  ...
  decisionLog: [], themes: [{ id: "default", name: "Default", overrides: {}, updated_at: "" }], defaultThemeId: "default", activeThemeId: "default", baseResolvedTokens: [{ id: "radius-md", name: "radius.md", foundation: "radius", type: "dimension", level: "primitive", value: "7px", description: "Default radius", order: 0, resolved_value: "7px", valid: true }], resolvedTokens: [{ id: "radius-md", name: "radius.md", foundation: "radius", type: "dimension", level: "primitive", value: "7px", description: "Default radius", order: 0, resolved_value: "7px", valid: true, base_resolved_value: "7px", source: "base", theme_id: null, override_dependencies: [] }], tokenIssues: [], filesRoot: "/tmp/monet",
} satisfies Workspace;
