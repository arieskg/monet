...
export function ExportPage() {
  ...
  const exportName = `monet-${workspace.profile?.id ?? "design-system"}-${resolvedWorkspace.activeThemeId}${resolvedWorkspace.activeMode === "light" ? "" : `-${resolvedWorkspace.activeMode}`}`;
