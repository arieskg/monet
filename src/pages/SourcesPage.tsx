...
export function SourcesPage() {
  ...
  return <div className="page">
    ...
    <div className="workspace-layout" id="sources-panel" role="tabpanel" aria-labelledby="sources-tab">
      ...
      <section className="editor-panel">{!draft ? <div className="blank-editor"><span className="eyebrow">Reference registry</span><h2>{workspace?.sources.length ? "Choose a source to inspect its mappings." : "No sources yet."}</h2><p>Sources describe inspiration and vocabulary. They do not imply a project dependency.{!workspace?.sources.length && " Add a source or import its JSON to start your reference registry."}</p></div> : <>
