...
export function ThemesPage() {
  ...
  const originLabel = (source: "base" | "mode" | "theme") => source === "theme" ? draft.name : source === "mode" ? `${modeLabels[activeMode]} mode` : "Base Monet";
  return <div className="page themes-page">
    ...
    <div className="themes-workspace">
      ...
      <section className="theme-detail">
        ...
        <section className="theme-equation" aria-label="Theme resolution"><span>Base Monet</span><b>+</b><span>{modes.includes("dark") ? "mode values" : "light values"}</span><b>+</b><span>{draft.name} overrides</span><b>=</b><strong>Resolved design system</strong></section>
